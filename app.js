...
function instagram (instagram) {
	...
	var instagramImage = "<div><a href=" + instaLink + " " + "target='_blank'><img src=" + instaImg + "></a></div>";
...
getFlickr ()
  ...
  //build the url of the Flickr photo
    ...
    var flickrImage = "<div><a href=" + flickrLinks + " " + "target='_blank'><img src=" + flickrImg + "></a></div>";
